...
<style>
    ...
    /* Prioridades */
    .priority-CRÍTICO  { color: #ff4d4d !important; font-weight: 800; font-size: 1.2rem; }
    .priority-ALTO     { color: #ffa500 !important; font-weight: 700; }
    .priority-MODERADO { color: #ffff00 !important; font-weight: 600; }
    .priority-BAIXO    { color: #00ff00 !important; font-weight: 500; }
    
    /* Sliders e Inputs contrast */
